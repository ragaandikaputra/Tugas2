    ...
    child: Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            'Es campur adalah salah satu minuman khas Indonesia yang cara membuatnya dengan mencampurkan berbagai jenis bahan dalam sirop manis.[1] Bahan yang dijadikan bahan biasanya berasa manis atau masam.',
          ),
        ),
        Container(
